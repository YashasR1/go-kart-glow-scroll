...
const HeroSection = () => {
  ...
  return (
    <section 
      id="home"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-contain bg-center bg-no-repeat md:bg-cover md:bg-[position:0_-200px]"
      style={{
